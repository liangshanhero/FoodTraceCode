...
@WebServlet(
		urlPatterns = { "/my/guest/article","/my/admin/article" }, 
		initParams = { 
				@WebInitParam(name = "listShowPage", value = "/pages/article/listShow.jsp"),
				@WebInitParam(name = "singleShowPage", value = "/pages/article/singleShow.jsp"),
				@WebInitParam(name = "adminListPage", value = "/pages/admin/article/listShow.jsp"),
				@WebInitParam(name = "adminSinglePage", value = "/pages/admin/article/singleShow.jsp"),
				@WebInitParam(name = "modifyShowPage", value = "/pages/admin/article/modifyShow.jsp"),
				@WebInitParam(name = "insertShowPage", value = "/pages/admin/article/insertShow.jsp")
		}		
)
