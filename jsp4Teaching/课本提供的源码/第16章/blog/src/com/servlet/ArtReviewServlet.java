...
@WebServlet(
		urlPatterns = { "/my/guest/artReview","/my/admin/artReview" }, 
		initParams = { 
				@WebInitParam(name = "artrListPage", value = "/pages/article/artReview.jsp"),
				@WebInitParam(name = "adminArtrListPage", value = "/pages/admin/article/artReview.jsp")
		}		
)
