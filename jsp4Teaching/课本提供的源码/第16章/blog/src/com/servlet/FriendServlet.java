...
@WebServlet(
		urlPatterns = { "/my/guest/friend","/my/admin/friend" }, 
		initParams = { 
				@WebInitParam(name = "listShowPage", value = "/pages/friend/listShow.jsp"),
				@WebInitParam(name = "adminListPage", value = "/pages/admin/friend/listShow.jsp"),
				@WebInitParam(name = "adminSinglePage", value = "/pages/admin/friend/singleShow.jsp")
		}		
)
