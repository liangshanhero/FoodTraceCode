CREATE DATABASE  IF NOT EXISTS `db_database13` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `db_database13`;
-- MySQL dump 10.13  Distrib 5.5.16, for Win32 (x86)
--
-- Host: localhost    Database: db_database13
-- ------------------------------------------------------
...
INSERT INTO `tb_bbsinfo` VALUES (1,'明日科技编程词典正在热售！','明日科技编程词典个人版正在火爆销售中。。。'),(2,'今明两天气温有所回升！','今明两天气温有所回升！'),(3,'关于端午节放假的通知！','关于端午节放假的通知！'),(4,'高考进行时...','今年高考期间我省均有降水！');
...
-- Dump completed on 2012-06-26 14:26:11
