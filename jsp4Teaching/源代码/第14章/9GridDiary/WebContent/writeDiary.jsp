...
<li>
	<div class="cssContent">
		<ul id="opt">
		<li>
	 	<input name="content" type="text" size="28" maxlength="15" value="请在此输入文字" onFocus="this.select()">
	  	</li>
...
<!-- ******************************* -->
	<ul id="weather"><li style="height:27px;"> <span id="now" style="font-size: 14px;font-weight:bold;padding-left:5px;">正在获取日期</span>
		...
		<img src="images/1.png" width="28" height="30">
		<input name="weather" type="radio" value="2">
  		<img src="images/2.png" width="28" height="30">
		<input name="weather" type="radio" value="3">
  		<img src="images/3.png" width="28" height="30"><br>
		<input name="weather" type="radio" value="4">
  		<img src="images/4.png" width="28" height="30">
		<input name="weather" type="radio" value="5" checked="checked">
  		<img src="images/5.png" width="28" height="30">
		<input name="weather" type="radio" value="6">
  		<img src="images/6.png" width="28" height="30"><br>
		<input name="weather" type="radio" value="7">
  		<img src="images/7.png" width="28" height="30">
		<input name="weather" type="radio" value="8">
  		<img src="images/8.png" width="28" height="30">
		<input name="weather" type="radio" value="9">
  		<img src="images/9.png" width="28" height="30">
  		</div> 
	</li>
  	</ul>
</li>
