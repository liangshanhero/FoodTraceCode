...
@WebServlet(
		urlPatterns = { "/my/guest/photo","/my/admin/photo" }, 
		initParams = { 
				@WebInitParam(name = "listShowPage", value = "/pages/photo/listShow.jsp"),
				@WebInitParam(name = "singleShowPage", value = "/pages/photo/singleShow.jsp"),
				@WebInitParam(name = "adminListPage", value = "/pages/admin/photo/listShow.jsp"),
				@WebInitParam(name = "adminSinglePage", value = "/pages/admin/photo/singleShow.jsp"),
				@WebInitParam(name = "upLoadPage", value = "/pages/admin/photo/upLoad.jsp")
		}		
)
