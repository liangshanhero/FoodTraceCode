...
@WebServlet(
		urlPatterns = { "/my/admin/mediaRev" }, 
		initParams = { 
				@WebInitParam(name = "mediaRlistPage", value = "/pages/media/mediaRev.jsp"),
				@WebInitParam(name = "adminMediaRListPage", value = "/pages/admin/media/mediaRev.jsp")
		}		
)
