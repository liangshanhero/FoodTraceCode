...
@WebServlet(
		urlPatterns = { "/my/guest/word","/my/admin/word" }, 
		initParams = { 
				@WebInitParam(name = "leaveWordPage", value = "/pages/word/leaveWord.jsp"),
				@WebInitParam(name = "listShowPage", value = "/pages/word/listShow.jsp"),
