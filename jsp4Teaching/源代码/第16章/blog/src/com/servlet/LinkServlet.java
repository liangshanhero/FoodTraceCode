...
@WebServlet(
		urlPatterns = { "/my/admin/link" }, 
		initParams = { 
				@WebInitParam(name = "adminListPage", value = "/pages/admin/link/listShow.jsp"),
				@WebInitParam(name = "insertPage", value = "/pages/admin/link/insertShow.jsp")
		}		
)
