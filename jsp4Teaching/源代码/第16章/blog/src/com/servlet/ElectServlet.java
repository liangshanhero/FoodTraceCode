...
@WebServlet(
		urlPatterns = { "/my/admin/elect" }, 
		initParams = { 
				@WebInitParam(name = "adminListPage", value = "/pages/admin/elect/listShow.jsp"),
				@WebInitParam(name = "insertPage", value = "/pages/admin/elect/insertShow.jsp")
		}		
)
