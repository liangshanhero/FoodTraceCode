		...
		<tr height="30">
			...
			<td rowspan="3" width="473" align="center">
				<object width="470" height="352" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">   
					<param name="movie" value="<%=basePath%>/pages/media/videos/player.swf?fileName=<%=basePath%>/pages/media/videos/${single.mediaSrc}"/> 
					<embed src="<%=basePath%>/pages/media/videos/player.swf?fileName=<%=basePath%>/pages/media/videos/${single.mediaSrc}" width="550" height="400"></embed>
				</object>
			</td>
