...
public class QRAppendMemo {  
    ...
    public static void main(String[] args) {  
        ...
        QRAppendMemo tt = new QRAppendMemo();  
  
        BufferedImage d = tt.loadImageLocal("d:\\codes\\EAN13.gif");  
        BufferedImage b = tt.loadImageLocal("d:\\codes\\华南农业大学二维条码.gif");    
        //往图片上写文件    
        //tt.writeImageLocal("E:\\ploanshare\\2\\22.jpg", tt.modifyImage(d, "000000", 90, 90));  
  
        tt.writeImageLocal("d:\\codes\\合并后的华南农业大学二维条码.gif", tt.modifyImagetogeter(d, b));    
        //将多张图片合在一起    
