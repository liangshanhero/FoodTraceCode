...
public class ProducttypeDAOTest {
	 ...
	 *
	 */
	private ProducttypeDAO dataStore;

	/**
	 * Instantiates a new ProducttypeDAOTest.
	 *
	 */
	...
	/**
	* Method to test Producttype domain object.
	*
	*/
	@Rollback(false)
	@Test
	...
	*/
	@Autowired
	public void setDataStore(ProducttypeDAO dataStore) {
