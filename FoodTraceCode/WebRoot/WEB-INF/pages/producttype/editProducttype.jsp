...
<html>
<head>
<title>Edit <fmt:message key="producttype.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProducttype" method="POST" modelAttribute="producttype">
