...
<html>
<head>
<title>Edit <fmt:message key="product.title"/> <fmt:message key="address.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProductAddress" method="POST" modelAttribute="address">
			<table cellpadding="0" cellspacing="0" id="viewTable">
				<tbody>
					...
					<tr>
						...
						<td>
							<form:input id="address_name" path="name" cssStyle="width:300px;"/>
							<script type="text/javascript">Spring.addDecoration(new Spring.ElementDecoration({elementId : "address_name",widgetType : "dijit.form.ValidationTextBox",widgetAttrs : {promptMessage: "<fmt:message key="address.name.help"/>"}})); </script>
						</td>
					</tr>
				</tbody>
			</table>
